...
const StyleGuide = () => {
  ...
  <div className="flex flex-col gap-y-4 p-24">
    ...
    <h3>Heading 3</h3>
    <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet aspernatur ut, dolore cum nesciunt dolores eaque blanditiis ullam odit consequuntur hic quae. Animi voluptas, ab nobis obcaecati sit dolores ratione.
    </p>
    </div>
