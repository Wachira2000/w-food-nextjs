...
const NavMobile = ({ containerStyles, iconStyles, linkStyles }) => {
  ...
  return (
    <div className={`${containerStyles}`}>
        ...
        className='cursor-ponter text-4xl text-white absolute w-10 h-10 left-8 top-8 bg-green flex items-center justify-center'>
            <IoCloseOutline/>
        </div>
        {/* {logo} */}
        <Link href='/'>
            <Image src='/assets/logo.svg' width={90} height={36} alt='logo'/>
        </Link>
